...
class Client:
    ...
    - 500: `bauplan.exceptions.InternalError`
    - 502: `bauplan.exceptions.BadGatewayError`
    - 503: `bauplan.exceptions.ServiceUnavailableError`
    - 504: `bauplan.exceptions.GatewayTimeoutError`
