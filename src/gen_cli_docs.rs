...
fn prompt_examples(s: &str) -> String {
    let mut out = Vec::new();
    let mut previous_nonempty_was_comment = false;
    ...
    for line in s.lines() {
        ...
        if previous_nonempty_was_comment || !saw_nonempty {
    ...
    out.push(CommandDoc {
        ...
        examples: cmd
            ...
            .map(|help| {
                ...
                prompt_examples(&dedent(stripped))
            })
