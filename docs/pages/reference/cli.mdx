...
| `--strict` | - | string | - | Exit upon encountering runtime warnings (e.g., invalid column output). [on, off] |
...
| Flag | Short | Type | Default | Description |
| --- | --- | --- | --- | --- |
| `--search-uri` | - | string | - | URI search string to S3 bucket containing parquet files (e.g., s3://bucket/path/a/*) (required) |
