...
description: "Run transactional data pipelines in Bauplan where every run is atomic. Outputs commit on success via temporary execution branches, leaving your data clean on failure."
---
