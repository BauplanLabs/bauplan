...
| `Decimal128[P, S]` | `decimal128(P, S)` | `decimal(P, S)` |
...
`Decimal128` takes precision and scale as type parameters rather than call
arguments, because a call isn't a valid type expression. Precision must be
between 1 and 38, and scale between 0 and the precision:

```python
#! from typing import Annotated, Literal
#! from bauplan import Decimal128, TableSchema
