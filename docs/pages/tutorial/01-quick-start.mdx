...
- **`bauplan_project.yaml`** - project metadata (id and name), this is also the place where [secrets](https://docs.bauplanlabs.com/common-scenarios/parameterized-runs#secrets) and [parameters](/reference/cli#bauplan-parameter) are stored.
