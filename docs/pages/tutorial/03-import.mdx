...
<Tip>
**Scheduled imports:** You can import data on a schedule. See our [scheduled ingestion example](https://github.com/BauplanLabs/bauplan/tree/main/examples/learn/03-safe-ingestion-on-a-schedule).
</Tip>
...
<Note>
- For more details see [table create-plan](/reference/cli#bauplan-table-create-plan) and [table create-plan-apply](/reference/cli#bauplan-table-create-plan-apply).
