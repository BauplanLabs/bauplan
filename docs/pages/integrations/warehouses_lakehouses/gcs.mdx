...
For querying the results of Bauplan pipelines from an external engine (for example, BigQuery) without any data copy, please refer to the [warehouse integration section](/integrations/warehouses_lakehouses/big_query_outbound).
