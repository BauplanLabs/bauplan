---
title: "marimo"
description: "Build a reactive marimo notebook on Bauplan with the Python SDK - query a lakehouse branch, add date filters, and chart results, then serve it as a web app."
hide_title: true
---
