...
description: "Use Bauplan in Jupyter, marimo, and Streamlit via the Python SDK to query tables, run pipelines, and explore lakehouse data on isolated branches."
---
...
<DocCardList
  items={[
    {
      type: "link",
      href: "/integrations/notebooks-data-apps/jupyter-notebooks",
    ...
    {
      type: "link",
      href: "/integrations/notebooks-data-apps/marimo",
      label: "Marimo",
      icon: marimoIcon,
    ...
    {
      type: "link",
      href: "/integrations/notebooks-data-apps/streamlit",
      label: "Streamlit",
      icon: streamlitIcon,
