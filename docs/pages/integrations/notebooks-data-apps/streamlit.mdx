---
title: "Streamlit"
description: "Build a Streamlit data app on Bauplan with the Python SDK - query a lakehouse branch by date range and render results as a table and Matplotlib chart."
hide_title: true
---
...
<Note>
  ...
  `alice.exploration_app`. [Learn more about
...
- Uses Bauplan SDK to execute SQL against a table in a data branch named `<username>.exploration_app` for a user-selected date range.
