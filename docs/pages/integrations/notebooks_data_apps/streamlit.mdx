...
<Note>
To isolate your data environment, run it on a branch (not on `main`). Branch names must be prefixed with your Bauplan username, for example `alice.exploration_app`. [Learn more about branches](/concepts/git_for_data/data_branches).
</Note>
