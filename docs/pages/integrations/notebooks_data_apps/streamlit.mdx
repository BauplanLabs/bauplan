...
[Streamlit](https://streamlit.io/) is a Python framework for turning scripts into interactive web apps. It is commonly used for lightweight dashboards, prototypes, and internal tools that can be built and shared quickly.
