...
description: "Land data in S3 with your ELT tool, then turn it into safe, queryable Iceberg tables in Bauplan. Register external tables or materialize from Parquet files."
---
