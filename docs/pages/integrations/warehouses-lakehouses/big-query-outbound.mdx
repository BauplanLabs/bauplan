...
Bauplan can use a GCP service account to access your BigQuery tables, which are then provided as Apache Arrow tables to your Python code. Note that every run involving an external connector will bypass the cache.
