...
<Note>
If your pipeline writes data, run it on a branch (not on `main`). Branch names must be prefixed with your Bauplan username, for example `alice.airflow_docs`. [Learn more about branches](/concepts/git_for_data/data_branches).
</Note>
...
Learn how to [set up parameters in Bauplan](/reference/cli#parameter-set).
