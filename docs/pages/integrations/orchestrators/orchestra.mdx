---
title: "Orchestra"
description: "Connect Bauplan to Orchestra and run pipelines, data quality tests, and custom SDK scripts from the GUI - no servers or local DAG code to manage."
---
...
1. In the left bar choose “connect a data platform”, then choose Bauplan from the list:
   ...
   ![Orchestra integrations page showing the Bauplan integration search result](../../../static/img/orchestrators/orchestra/d36418f8-74ac-4ea9-8c95-b09da4737024.png)

2. Then input your Bauplan API key and follow the instructions to connect your repository with your Bauplan code.

   ![Orchestra Bauplan connection form with API key and repository credentials](../../../static/img/orchestrators/orchestra/229f427a-16ba-4009-ab6b-44d53b9df106.png)

   When completed, your integration with Bauplan should appear under **Integrations → Connected** in the Orchestra sidebar.

   ![Orchestra integrations list showing the Bauplan connection as connected](../../../static/img/orchestrators/orchestra/Screenshot_2025-10-15_at_10.04.43_AM.png)
...
1. **Bauplan Execute Pipeline**
   ...
   Run a Bauplan pipeline or one model defined in your project and monitor its status inside Orchestra. → See [docs.getorchestra.io/docs/integrations/bauplan/bauplan_execute_pipeline](https://docs.getorchestra.io/docs/integrations/bauplan/bauplan_execute_pipeline)
...
2. Add a Bauplan task.
   ...
   ![Orchestra Bauplan Execute Pipeline task parameter form](../../../static/img/orchestrators/orchestra/4813cc60-4ac4-49c6-8b35-5f9ad3ba6a1a.png)
...
5. Save and trigger the pipeline. Upon successful completion you should see this.
   ...
   ![Successful Orchestra pipeline run with Bauplan task details panel](../../../static/img/orchestrators/orchestra/74a04bc3-61d9-4021-9027-d487cd76c415.png)
