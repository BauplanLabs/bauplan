...
description: "Run Bauplan jobs in detached mode for scheduled or long-running pipelines. Submit, poll job status, fetch logs, and cancel jobs from the CLI or Python SDK."
---
