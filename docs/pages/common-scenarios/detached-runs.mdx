...
- **Production / scheduled pipelines** - a scheduler (e.g. Airflow, cron) triggers a pipeline on a recurring cadence and does not need to hold a connection open for the entire run.
