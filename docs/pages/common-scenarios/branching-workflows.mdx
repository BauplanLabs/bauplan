...
description: Learn the ways of working with data branches in Bauplan. Compare data-first and code-first workflows for promoting validated changes from a branch to production.
---
