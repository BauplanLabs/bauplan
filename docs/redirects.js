const redirects = [
  ...
  { from: '/concepts/schema-conflicts', to: '/common-scenarios/schema-conflicts' },
  ...
  { from: '/guides/secrets', to: '/common-scenarios/parameterized-runs#secrets' },
  ...
  { from: '/llms/mcp_server', to: '/agents/overview#1-mcp-server' },
